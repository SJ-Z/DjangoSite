...
class RegisterForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        if 'request' in kwargs:
            self.request = kwargs.pop('request')  # pop()将参数从关键字参数中取出并剔除，避免其影响本身__init__方法的执行
...
class ChangeNicknameForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        if 'user' in kwargs:
            self.user = kwargs.pop('user')  # pop()将参数从关键字参数中取出并剔除，避免其影响本身__init__方法的执行
